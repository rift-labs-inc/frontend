...
abstract contract RiftExchangeAbstract is BlockHeaderStorage {
    ...
    uint256 public constant MIN_WBTC_DEPOSIT = 0.5 ether;
    uint256 public constant MAX_WBTC_DEPOSIT = 200_000 ether; // TODO: find out what the real max deposit is

    // TODO : pass the constants as constructor arguments to rift exchange abstract
