        ...
        <Flex
            ...
            <Flex w='90%' direction={'column'}>
                <Flex w='100%' flexDir='column' position='relative'>
                    ...
                    <Flex px='10px' bg='#2E1C0C' w='100%' h='105px' border='2px solid #78491F' borderRadius={'10px'}>
                        <Flex direction={'column'} py='10px' px='5px'>
                            ...
                            <Flex>
                                {!loading && (
                                    <Text
                                        color={overpayingBtcInput || isBelowMinBtcInput || isAboveMaxSwapLimitBtcInput ? colors.redHover : !btcInputSwapAmount ? colors.offWhite : colors.textGray}
                                        fontSize={'13px'}
                                        mt='2px'
                                        ml='1px'
                                        letterSpacing={'-1px'}
                                ...
                                {parseFloat(btcInputSwapAmount) != 0 &&
                                    ...
                                    !overpayingBtcInput &&
                                    !isBelowMinBtcInput && (
                                        <Text ml='8px' fontSize={'13px'} mt='2px' mr='-116px' zIndex={'10'} color={colors.textGray} letterSpacing={'-1.5px'} fontWeight={'normal'} fontFamily={'Aux'}>
                    ...
                    {/* USDT Output */}
                    <Flex mt='5px' px='10px' bg={selectedInputAsset.dark_bg_color} w='100%' h='105px' border='2px solid' borderColor={selectedInputAsset.bg_color} borderRadius={'10px'}>
                        <Flex direction={'column'} py='10px' px='5px'>
                            <Text
                ...
                <Flex
                    ...
                    <Text userSelect={'none'} color={usdtOutputSwapAmount && btcInputSwapAmount ? colors.offWhite : colors.darkerGray} fontFamily='Nostromo'>
                        ETH GAS FEES ARE TOO HIGH FOR RIFT SWAPS :(
                    </Text>
                </Flex>
            </Flex>
        </Flex>
