...
import { RouteButton, ROUTES } from '../../types';
        ...
        return (
            <Flex
                ...
                <Flex w={contentWidth} flex={1} align='flex-start' flexDir='column'>
                    <Flex w='100%' px='20px' py='0px' align='center' justify='space-between'>
                        <Image src='/images/logos/rift.svg' h='13px' alt='Rift' userSelect='none' />
                        <Hamburger toggled={isOpen} toggle={setOpen} size={18} rounded label='Show Menu' color='white' />
                    </Flex>
                    ...
                    {!hideItems && (
                        <Flex
                            ...
                            <Flex flexDir='column' justify='space-around' px='20px' w='100%' gap='20px'>
                                    ...
                                    return (
                                        <NavItem
                                            ...
                                            onClick={() => {
                                                try {
                                                    setOpen(false);
                                                    setTimeout(() => setHideItems(true), animationDelay.num);
                                                    router.push(url);
                                                } catch (error) {
                                                    console.error(error);
                                                }
                ...
                <Flex w='100%' h='1px' bgGradient={`linear-gradient(90deg, ${colors.RiftBlue} 0%, ${colors.RiftOrange} 100%)`} opacity={0.6} />
            </Flex>
        );
};
