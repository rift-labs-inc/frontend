...
export const SwapUI = ({}) => {
    ...
    if (validateSwapInput(btcValue)) {
      ...
      const ethValue =
        btcValue && parseFloat(btcValue) > 0
          ? (parseFloat(btcValue) * 18.485204).toFixed(8)
          : "";
    ...
    if (validateSwapInput(ethValue)) {
      ...
      const btcValue =
        ethValue && parseFloat(ethValue) > 0
          ? (parseFloat(ethValue) / 18.485204).toFixed(8)
          : "";
      setBtcSwapAmount(btcValue);
    }
  };
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <Flex direction="column" align="center" mt="18px">
        {activeTab === "swap" && (
        ...
        {activeTab === "liquidity" && (
          <Flex w="90%" direction={"column"}>
            ...
            >
              ...
              >
                {`${
                  parseFloat(ethDepositAmount) *
                    (parseFloat(lpFee.replace("%", "")) / 100) || 0
                } ETH`}
              </Text>
            </Flex>
            {/* BTC Payout Address */}
