    ...
    >
      ...
      <Flex direction={"column"} align="center" w="100%" h="100%" mt="105px">
        ...
        <Flex direction={"column"} align="center" w="100%">
          ...
          >
            See avalible liquidity, sort by fees, or swap from multiple LPs at
            once.
          </Text>
        </Flex>
        ...
        >
          <Flex w="100%" mt="-55px" mb="8px" h="44px">
            ...
            <Flex
              ...
              align={"center"}
              border={
                selectMultiple ? "2px solid #445BCB" : "2px solid #282828"
              }
            >
                    ...
                    >
                      <Flex ml="33px" w="170px" textAlign="left">
                        <Text color={colors.offerWhite}>
                          {timeAgo(deposit.timestamp)}
                        </Text>
                      </Flex>
                      <Flex w="180px" textAlign="left">
                        <Text color={colors.textGray}>
                          {formatAddress(deposit.lp)}
                        </Text>
                      </Flex>
                      <Flex w="85px">
                        <BTCSVG />
                      ...
                      <Flex
                        ...
                        userSelect={"none"}
                        onClick={() =>
                          copyToClipboard(deposit.amount, "Amount copied")
                        }
                      >
                        <Tooltip
                          fontFamily={"Aux"}
                      ...
                      <Flex
                        ...
                        color={colors.textGray}
                        onClick={() =>
                          copyToClipboard(deposit.lp_fee, "LP Fee copied")
                        }
                      >
                        <Tooltip
                          fontFamily={"Aux"}
