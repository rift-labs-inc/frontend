                    ...
                    <Flex
                        ...
                        <Flex w='100%' mt='-55px' mb='8px' h='44px'>
                            ...
                            <Flex
                                ...
                                align={'center'}
                                border={showMyActivity ? '2px solid #445BCB' : '2px solid #282828'}>
                                <Text
                                    fontFamily={'Aux'}
                                    fontWeight={'normal'}
                                    ml='14.5px'
                                    ...
                                    <Flex
                                        ...
                                        {activityData.map((order, index) => (
                                            <Flex
                                                ...
                                                <Flex w='180px' textAlign='left'>
                                                    <Text color={colors.textGray}>{formatAddress(order.txn_hash)}</Text>
                                                </Flex>
                                                <Flex w='200px' textAlign='left'>
                                                ...
                                                <Flex w='180px' textAlign='left'>
                                                    <Text color={colors.offerWhite}>{formatAddress(order.to_address)}</Text>
                                                </Flex>
                                                <Flex
                                                    w='85px'
                                                    textAlign='left'
                                                    ...
                                                    userSelect={'none'}
                                                    color={colors.textGray}
                                                    onClick={() => copyToClipboard(order.lp_fee, 'LP Fee copied')}>
                                                    <Tooltip
                                                        fontFamily={'Aux'}
                                                        letterSpacing={'-0.5px'}
                                                        color={colors.textGray}
                                                ...
                                                <Flex
                                                    ...
                                                    cursor={'pointer'}
                                                    userSelect={'none'}
                                                    onClick={() => copyToClipboard(order.amount, 'Amount copied')}>
                                                    <Tooltip
                                                        fontFamily={'Aux'}
                                                        letterSpacing={'-0.5px'}
                                                        color={colors.textGray}
                                                ...
                                                <Flex w='100px' textAlign='left'>
                                                    ...
                                                    <Text userSelect={'none'} color={order.status == 'Completed' ? '#238739' : colors.textGray}>
                                                        {order.status}
                                                    </Text>
                                                </Flex>
                                            </Flex>
    ...
    return (
        <svg width='100' height='20' viewBox='0 0 200 46' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            <path
                ...
                fill='#627EEA'
            />
            <path d='M23.5957 5.95361V18.6397L34.3181 23.431L23.5957 5.95361Z' fill='white' fill-opacity='0.602' />
            <path d='M23.5959 5.95361L12.8721 23.431L23.5959 18.6397V5.95361Z' fill='white' />
            <path d='M23.5957 31.6521V40.2721L34.3253 25.4277L23.5957 31.6521Z' fill='white' fill-opacity='0.602' />
            <path d='M23.5959 40.2721V31.6507L12.8721 25.4277L23.5959 40.2721Z' fill='white' />
            <path d='M23.5957 29.6568L34.3181 23.431L23.5957 18.6426V29.6568Z' fill='white' fill-opacity='0.2' />
            <path d='M12.8721 23.431L23.5959 29.6568V18.6426L12.8721 23.431Z' fill='white' fill-opacity='0.602' />
            <path
